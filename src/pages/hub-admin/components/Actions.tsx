...
import { useUpdateHubStatusMutation } from "../../../hooks/hub-admin/mutation/useUpdateHubStatus.mutation";
...
const Actions: React.FC<IProps> = ({
  ...
  const { mutateAsync, isLoading } = useUpdateHubStatusMutation(search, paging);
