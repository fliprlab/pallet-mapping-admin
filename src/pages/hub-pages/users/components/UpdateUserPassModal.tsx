...
import { useUpdateUserPassHubMutation } from "../../../../hooks/users/mutation/hub/useUpdateUserPassHub.mutation";
import {
...
const UpdateUserPassModal = (
  ...
  const { isLoading, mutateAsync } = useUpdateUserPassHubMutation(
    props.search,
    props.paging
  );
